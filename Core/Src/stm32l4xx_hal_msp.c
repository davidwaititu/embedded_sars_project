...
void HAL_DFSDM_FilterMspInit(DFSDM_Filter_HandleTypeDef* hdfsdm_filter)
{
  ...
  */
    ...
    PC2     ------> DFSDM1_CKOUT
    */
    GPIO_InitStruct.Pin = MIC_DAT_Pin|MIC_CLK_Pin;
...
void HAL_DFSDM_FilterMspDeInit(DFSDM_Filter_HandleTypeDef* hdfsdm_filter)
{
  ...
  if(DFSDM1_Init == 0)
    ...
    PC2     ------> DFSDM1_CKOUT
    */
    HAL_GPIO_DeInit(GPIOC, MIC_DAT_Pin|MIC_CLK_Pin);
...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
  ...
  if(hspi->Instance==SPI2)
  {
    ...
    PB14     ------> SPI2_MISO
    */
    GPIO_InitStruct.Pin = OBI_SPI2_MOSI_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF5_SPI2;
    HAL_GPIO_Init(OBI_SPI2_MOSI_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = OB_SPI2_SCK_Pin|OB_SPI2_MISO_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF5_SPI2;
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  if(hspi->Instance==SPI2)
  {
    ...
    PB14     ------> SPI2_MISO
    */
    HAL_GPIO_DeInit(OBI_SPI2_MOSI_GPIO_Port, OBI_SPI2_MOSI_Pin);

    HAL_GPIO_DeInit(GPIOB, OB_SPI2_SCK_Pin|OB_SPI2_MISO_Pin);
